...
```sh
MIRAVIEWER_ALIGNMENT_DESKTOP_CORPUS_DIR='/Users/blader/Desktop/Critical MRI Source Images (LLM Agent - do not delete)' npm run test -- tests/alignmentAutomaticCorpus.test.ts
```
