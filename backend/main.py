...
def _build_acp_analysis_prompt(
    *,
    ...
    return (
        ...
        "(2) include highly visual, layperson localizing instructions (where on the visible image to look: top/bottom/left/right/center, anterior/posterior if inferable, relative to bright/dark landmarks); "
        "(3) include explicit segmentation instructions (what boundaries/components to outline) with on-screen placement cues (e.g., “draw a thin cyan outline around the bright cystic area sitting just above the sella in the midline; place its label just above and to the right, outside the outline”); "
